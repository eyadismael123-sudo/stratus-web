...
export default function AgentPricingCTA({ template }: AgentPricingCTAProps) {
  ...
  return (
    <section className="px-8 max-w-7xl mx-auto mb-24">
      <div className="bg-[#4E0110] p-16 rounded-xl text-center relative overflow-hidden">
        <div className="relative z-10">
          ...
          <Link href="/marketplace">
            <button className="bg-[#CCDAD1] text-[#4E0110] px-12 py-5 rounded font-display font-bold text-lg hover:bg-white transition-colors">
              Get Started Now
            </button>
          </Link>
        </div>
        <div className="absolute inset-0 opacity-20 pointer-events-none bg-[radial-gradient(circle_at_50%_120%,#EB0043,transparent)]" />
      </div>
    </section>
  );
}
